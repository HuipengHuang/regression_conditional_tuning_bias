        ...
        with torch.no_grad():
            ...
            for data, target in test_loader:
                ...
                for i in range(data.shape[0]):
                    ...
                    prediction_set_size1, coverage1, acc1 = self.calibrate_instance1(data[i], target[i], alpha=self.alpha)
                    print(prediction_set_size==prediction_set_size1, coverage==coverage1, acc==acc1)
