# datasets used in the paper: A comparison of some conformal quantile regression methods
import numpy as np
import pandas as pd
...
class customized_dataset(Dataset):
    def __init__(self, name, base_path="./data/"):
        super(customized_dataset, self).__init__()
        self.X, self.y = GetDataset(name, base_path)
...
def GetDataset(name, base_path="./data/"):
    """ Load a datasets

    Parameters
    ----------
    name : string, datasets name
